// src/app/api/admin/wani-partner/upload/route.ts
// رفع صورة خلفية (creative) لكارت WANI Partner → Cloudinary
...
export async function POST(req: NextRequest) {
  ...
  if (!session?.user?.isSuper) return NextResponse.json({ error: "Forbidden" }, { status: 403 });
