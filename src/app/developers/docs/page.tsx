...
const ENDPOINTS: Endpoint[] = [
  {
    ...
    fields: [
      ...
      { name: "messagesLeft", type: "number", desc: "Trial plans only — remaining free messages", descAr: "خطط التجربة فقط — الرسائل المجانية المتبقية" },
...
const ERROR_CODE_ROWS: ErrorCodeRow[] = [
  ...
  { code: "NO_ACTIVE_PLAN / TRIAL_EXPIRED", http: 403, en: "Subscription or trial exhausted", ar: "الاشتراك أو التجربة انتهت", action: "Renew or upgrade the project plan", actionAr: "جدد أو رقِّ خطة المشروع" },
