...
export default function PortalTopBar({
  ...
  async function handleLogout() {
    ...
    window.location.href = devPath("/signin");
  }

  const docsActive = pathname.startsWith(devPath("/docs"));
      ...
      <header className="ptopbar">
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          {ownerOnly ? (
            ...
            <Link href={devPath("/portal")} className="ptopbar-brand">
              <img src="/landingpage-dev.svg" alt={t("Wani", "وني")} className="ptopbar-brand-icon" />
              <span className="ptopbar-brand-name">{t("Wani", "وني")}</span>
            ...
            {menuOpen && (
              <>
                ...
                <div className="ptopbar-menu" style={{ direction: language === "ar" ? "rtl" : "ltr" }}>
                  ...
                  <Link href={devPath("/portal/settings")} className="menu-item" style={{ textDecoration: 'none', textAlign: language === "ar" ? "right" : "left", flexDirection: language === "ar" ? "row" : "row-reverse", justifyContent: language === "ar" ? "flex-start" : "flex-end" }}>
