    ...
    <>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=IBM+Plex+Sans+Arabic:wght@300;400;500;600&family=Fira+Code:wght@400;500&display=swap');
          ...
          .user-email { font-size: 11px; color: rgba(255,255,255,0.3); direction: ltr; text-align: ${language === 'ar' ? 'right' : 'left'}; }
      ...
      <aside className={`sidebar ${isMobileNavOpen ? 'mobile-open' : ''}`}>
        ...
        <nav className="sidebar-nav">
          <div className="nav-section-label">{t("Main", "الرئيسية")}</div>
