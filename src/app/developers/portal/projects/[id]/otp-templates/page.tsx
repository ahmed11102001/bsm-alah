                  ...
                  <>
                    <div className="otp-section">
                      ...
                      <div style={{ fontSize: 12, color: "rgba(255,255,255,0.5)", lineHeight: 1.8, marginBottom: 4 }}>
                        ...
                        <div>✅ {t("Body: standard OTP text auto-generated by Meta", "النص: نص OTP قياسي تولّده Meta تلقائيًا")}</div>
                        <div>✅ {t("Button: Copy Code (fixed)", "الزر: نسخ الكود (ثابت)")}</div>
                        <div>✅ {t("Code expiry: applied to the Meta template", "مدة الصلاحية: تُطبق على قالب Meta")}</div>
                      </div>
