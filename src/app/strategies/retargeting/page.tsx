...
import RetargetingCinematic from "./_components/RetargetingCinematic";
...
function PageInner() {
    ...
    return (
        <div dir={dir} className="min-h-screen relative overflow-hidden" style={{ background: "#050710" }}>
            {/* خلفية دافئة خفيفة بلون هوية الاستراتيجية (وردي/أحمر) فوق نفس خلفية صفحة /strategies */}
            <div
                className="pointer-events-none fixed inset-0"
                style={{
                    background:
                        "radial-gradient(ellipse at 50% 20%, rgba(251,113,133,0.08) 0%, rgba(5,7,16,1) 65%)",
                }}
            />
            <div
            ...
            <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
                ...
                <div className="text-center mb-2 sm:mb-4">
                    <div className="inline-flex items-center gap-2 text-[11px] font-semibold tracking-[0.3em] uppercase mb-1" style={{ color: "rgba(251,113,133,0.75)" }}>
...
export default function RetargetingStrategyPage() {
    return (
        <LanguageProvider>
            <PageInner />
        </LanguageProvider>
