...
import CampaignsCinematic from "./_components/CampaignsCinematic";
...
function PageInner() {
    ...
    return (
        <div dir={dir} className="min-h-screen relative overflow-hidden" style={{ background: "#050710" }}>
            {/* خلفية سماوية خفيفة بلون هوية استراتيجية الحملات (سماوي/تركواز) */}
            <div
                className="pointer-events-none fixed inset-0"
                style={{ background: "radial-gradient(ellipse at 50% 20%, rgba(34,211,238,0.08) 0%, rgba(5,7,16,1) 65%)" }}
            />
            <div
            ...
            <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
                ...
                <div className="text-center mb-2 sm:mb-4">
                    <div className="inline-flex items-center gap-2 text-[11px] font-semibold tracking-[0.3em] uppercase mb-1" style={{ color: "rgba(34,211,238,0.8)" }}>
...
export default function CampaignsStrategyPage() {
    return (
        <LanguageProvider>
            <PageInner />
        </LanguageProvider>
