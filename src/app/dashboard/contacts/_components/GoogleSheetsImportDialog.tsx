        ...
        {featureLocked ? (
          <div className="py-10 text-center space-y-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">{text("قم بالترقية إلى Go أو أعلى لاستيراد الجمهور ومزامنته من Google Sheets.", "Upgrade to Go or higher to import and sync audiences from Google Sheets.", locale)}</p>
            </div>
          </div>
        ) : !connection ? (
          <div className="py-8 text-center space-y-4">
            ...
            <Button className="bg-primary hover:bg-primary/90 text-primary-foreground" onClick={() => { window.location.href = "/api/google-sheets/connect" }}>
