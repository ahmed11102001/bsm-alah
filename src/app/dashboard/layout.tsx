...
function DashboardShellInner({ children }: { children: React.ReactNode }) {
  ...
  // ── نتيجة ربط Shopify التلقائي اتنقلت لمركز القنوات ──
  // الـ callback بيوجّه لـ /channels ومعالج الـtoast هناك (ShopifyOAuthToast).
  // اتشال من هنا عشان ميحصلش toast مكرر.
