    ...
    <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-5 sm:p-6 backdrop-blur-md">
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-center gap-3">
          <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-pink-500/15 border border-pink-500/25 flex-shrink-0">
            <Cake className="h-5 w-5 text-pink-300" />
          </span>
          <div>
            <h2 className="text-base font-extrabold text-white">أتمتة عيد الميلاد 🎂</h2>
        ...
        <div className="mt-4 space-y-3">
          <label className="block text-xs font-semibold text-white/70">
            ...
            <select
              ...
              className="mt-1.5 w-full rounded-xl border border-white/10 bg-white/[0.04] px-3 py-2.5 text-sm text-white focus:border-pink-500 focus:outline-none"
            >
          ...
          <label className="flex items-center justify-between gap-3 rounded-xl border border-white/10 bg-white/[0.02] px-3.5 py-3 cursor-pointer">
            <span className="text-sm font-semibold text-white/85">تفعيل الأتمتة اليومية</span>
            <button
              type="button"
              role="switch"
          ...
          <button
            ...
            onClick={save}
            disabled={saving}
            className="w-full sm:w-auto rounded-xl bg-gradient-to-r from-pink-600 to-rose-600 px-6 py-2.5 text-sm font-bold text-white shadow-lg shadow-pink-500/20 hover:brightness-110 active:scale-95 transition-all disabled:opacity-50"
          >
