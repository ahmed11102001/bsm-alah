...
export const metadata = {
  title: "سياسة الخصوصية |وني",
  description: "سياسة الخصوصية لمنصة وني لإدارة حملات واتساب التسويقية",
};
...
const sections = [
  {
    id: "intro",
    title: "مقدمة",
    content: `مرحباً بك في وني. نحن نأخذ خصوصيتك بجدية تامة. توضح هذه السياسة كيفية جمعنا واستخدامنا وحمايتنا للمعلومات التي تقدمها عند استخدام منصتنا لإدارة حملات واتساب التسويقية عبر WhatsApp Business API.
      ...
      <div className="bg-[#075E54]">
        <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-white font-bold text-sm"> وني</span>
          </div>
        </div>
      </div>
