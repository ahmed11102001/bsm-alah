...
import { DEMO_REPORTS_STORE } from "../../_lib/demo-data";

export default function DemoReportsStorePage() {
    ...
    const fetchStoreReport = useCallback(async () => {
        ...
        let orders = DEMO_REPORTS_STORE.confirmedOrders;
        if (orderFilter !== "all") orders = orders.filter(o => o.status === orderFilter);
        setStoreReport({ ...DEMO_REPORTS_STORE, confirmedOrders: orders });
        setLS(false);
