...
import { DEMO_AUTOMATION_REPORT } from "../../_lib/demo-data";
...
// ─── Main Component ──────────────────────────────────────────────────────────
export default function DemoAutomationReportTab() {
    ...
    const fetchData = useCallback(async () => {
        ...
        setData(DEMO_AUTOMATION_REPORT);
        setLoading(false);
    }, []);
                            ...
                            {errorLog.length === 0 ? (
                                ...
                                errorLog.map((err) => (
                                    <button
                                        ...
                                        className={`w-full text-left p-4 rounded-2xl border transition ${selectedError?.id === err.id
