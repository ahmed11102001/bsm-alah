  ...
  const languageInstruction =
    ctx.languageMode === "ar"
      ...
      : ctx.languageMode === "en"
        ...
        : [
            "ردّ بنفس لغة آخر رسالة من العميل (عربي أو إنجليزي أو أي لغة تانية) بشكل افتراضي.",
            "استثناء مهم: لو العميل طلب صراحةً في أي وقت خلال المحادثة إنك ترد بلغة معينة",
            "(مثلاً: \"رد عليا بالإنجليزي\"، \"اتكلم عربي بس من فضلك\"، \"Please reply in English only\")،",
            "التزم باللغة اللي طلبها لباقي المحادثة كلها، حتى لو هو نفسه كتب بعد كده رسالة بلغة تانية —",
            "إلا لو قال صراحة إنه عايز يرجع للوضع التلقائي (زي \"رد عادي\" أو \"مفيش داعي تتقيد بلغة معينة\").",
          ].join(" ");
