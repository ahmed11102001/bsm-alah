    ...
    plans: [
      ...
      },
      {
        ...
        features: [
          ...
          { ar: "مساعد Claude AI(50 امر شهريا) ", en: "Claude AI assistant (50 prompts/month)", ok: true },
          { ar: "تقارير مبيعات وتحليلات متقدمة + تصدير Excel/CSV", en: "Advanced sales analytics + Excel/CSV export", ok: true },
          { ar: " رد صوتي ذكي بواسطة eleven labs  ", en: "AI Voice by eleven labs", ok: true },
        ],
      },
      {
        name: { ar: "Max", en: "Max" },
        ...
        features: [
          ...
          { ar: "١٬٠٠٠٬٠٠٠ توكن Aشهرياً ت ", en: "1,000,000 AI tokens/month ", ok: true },
          ...
          { ar: "برنامج شركاء وني", en: "Wani partner program", ok: true },
