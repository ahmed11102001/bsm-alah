...
export const t = {
  ...
  pricing: {
    ...
    plans: [
      {
        name: { ar: "Free", en: "Free" },
        tagline: { ar: "ابدأ وجرب وني بدون أي تكلفة أو التزام", en: "Start free with zero commitment" },
        badge: { ar: "دائماً مجاناً", en: "Always Free" },
        cta: { ar: "ابدأ مجاناً", en: "Start Free" },
        slug: "free",
        features: [
          { ar: "١٠٠ جهة اتصال نشطة", en: "100 Active contacts", ok: true },
          { ar: "مستخدم ١ (صندوق وارد فردي)", en: "1 User (Personal inbox)", ok: true },
          { ar: "٣ حملات شهرياً (رسائل نصية)", en: "3 Campaigns/month (Text only)", ok: true },
          { ar: "محادثات مباشرة غير محدودة", en: "Unlimited live conversations", ok: true },
          { ar: "ردود تلقائية بالكلمات المفتاحية", en: "Keyword auto-replies", ok: true },
          { ar: "لوحة تحكم وإحصائيات أساسية", en: "Basic dashboard & analytics", ok: true },
        ],
      },
      {
        name: { ar: "Go", en: "Go" },
        tagline: { ar: "انطلاقة قوية وسريعة للمشاريع الناشئة والرواد", en: "For startups & growing entrepreneurs" },
        badge: { ar: "بداية مثالية 🚀", en: "Perfect Start 🚀" },
        cta: { ar: "انطلق مع Go", en: "Get Started with Go" },
        slug: "go",
        features: [
          { ar: "٢٬٥٠٠ جهة اتصال نشطة", en: "2,500 Active contacts", ok: true },
          { ar: "٢ مستخدمين (صندوق وارد موحد للفريق)", en: "2 Team users (Shared inbox)", ok: true },
          { ar: "٥٠ حملة شهرياً + إرسال مجدول", en: "50 Campaigns/month + Scheduling", ok: true },
          { ar: "جميع أنواع الميديا (صور، فيديو، PDF، صوت)", en: "All media (Images, videos, PDFs, audio)", ok: true },
          { ar: "شات بوت تفاعلي وقوائم أزرار ذكية", en: "Interactive chatbot & smart buttons", ok: true },
          { ar: "تزامن واستيراد جهات الاتصال من Google Sheets", en: "Google Sheets contact sync & import", ok: true },
          { ar: "تقارير أداء وتفاعل الحملات", en: "Campaign delivery & engagement reports", ok: true },
        ],
      },
      {
        name: { ar: "Pro", en: "Pro" },
        tagline: { ar: "الخيار الاحترافي الأقوى للمتاجر والشركات المتنامية", en: "The powerhouse for stores & scaling brands" },
        badge: { ar: "الأكثر طلباً 💎", en: "Most Popular 💎" },
        cta: { ar: "اختر باقة Pro", en: "Upgrade to Pro" },
        slug: "pro",
        features: [
          { ar: "٢٥٬٠٠٠ جهة اتصال نشطة", en: "25,000 Active contacts", ok: true },
          { ar: "٥ مستخدمين + توزيع المحادثات تلقائياً", en: "5 Users + Auto chat assignment", ok: true },
          { ar: "حملات غير محدودة ∞ + المتابعة الذكية (Smart Follow-Up)", en: "Unlimited campaigns + Smart Follow-Up", ok: true },
          { ar: "ربط المتاجر (Shopify, WooCommerce, EasyOrders)", en: "Store sync (Shopify, WooCommerce, EasyOrders)", ok: true },
          { ar: "استرجاع السلات المتروكة وتأكيد الطلبات تلقائياً", en: "Automated abandoned cart & order confirmations", ok: true },
          { ar: "مساعد Claude AI لكتابة وتحسين الرسائل", en: "Claude AI assistant for copy & replies", ok: true },
          { ar: "تقارير مبيعات وتحليلات متقدمة + تصدير Excel/CSV", en: "Advanced sales analytics + Excel/CSV export", ok: true },
          { ar: "دعم فني سريع ذو أولوية عبر واتساب", en: "Priority WhatsApp technical support", ok: true },
        ],
      },
      {
        name: { ar: "Max", en: "Max" },
        tagline: { ar: "الحل الشامل للشركات الكبرى مع موظف مبيعات AI متكامل", en: "The ultimate enterprise AI workforce" },
        badge: { ar: "أقصى قوة وذكاء 👑", en: "Ultimate Power 👑" },
        cta: { ar: "امتلك باقة Max", en: "Get Max Plan" },
        slug: "max",
        features: [
          { ar: "جهات اتصال غير محدودة ∞", en: "Unlimited active contacts ∞", ok: true },
          { ar: "١٠ مستخدمين للفريق مع إدارة صلاحيات متقدمة", en: "10 Team users + Advanced role management", ok: true },
          { ar: "إيجنت وني الذكي (Wani AI Sales & Support Agent)", en: "Wani AI Sales & Support Agent", ok: true },
          { ar: "١٬٠٠٠٬٠٠٠ توكن AI شهرياً + دعم الصوت ElevenLabs", en: "1,000,000 AI tokens/month + ElevenLabs voice", ok: true },
          { ar: "نظام تدريب إيجنت مخصص (Human-in-the-Loop Training)", en: "Human-in-the-Loop AI Agent Training", ok: true },
          { ar: "ربط برمجيات API كامل + أوامر Claude MCP غير محدودة", en: "Full Developer API + Unlimited Claude MCP", ok: true },
          { ar: "كارت ومزايا شركاء وني (Wani Partner Perks)", en: "Wani Partner Perks & exclusive benefits", ok: true },
          { ar: "مدير حساب مخصص + دعم VIP على مدار الساعة ٢٤/٧", en: "Dedicated Account Manager + 24/7 VIP Support", ok: true },
        ],
      },
    ],
  },
...
If a customer asks directly — we recommend transparency, and there's a setting where you define how that question gets handled.` },
  ...
  footer: {
    ...
    copyright: { ar: "© 2026 WANI — مدارة بواسطة وني. جميع الحقوق محفوظة.", en: "© 2026 WANI — powerd by wani. All rights reserved." },
