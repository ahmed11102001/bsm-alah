...
If a customer asks directly — we recommend transparency, and there's a setting where you define how that question gets handled.` },
  ...
  footer: {
    ...
    copyright: { ar: "© 2026 وني — مملوكة ومدارة بواسطة احمد عادل عبد الفتاح اسماعيل. جميع الحقوق محفوظة.", en: "© 2026 WANI — Owned and operated by Ahmed Adel Abdel Fattah Ismail. All rights reserved." },
