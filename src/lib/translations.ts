    ...
    plans: [
      {
        ...
        features:[
          ...
          { ar: "Chatbot بردود ثابتة",   en: "Chatbot (fixed replies)",   ok: false },
          { ar: "جماهير مخصصة",          en: "Custom audiences",          ok: false },
          { ar: "أتمتة الردود",          en: "Auto-replies",              ok: false },
          { ar: "ربط متجر",              en: "Store integration",         ok: false },
          { ar: "AI Sales Assistant",    en: "AI Sales Assistant",        ok: false },
        ],
      },
      {
      ...
      },
      {
        ...
        features:[
          ...
          { ar: "Chatbot متقدم",           en: "Advanced Chatbot",          ok: true  },
          { ar: "جماهير مخصصة + VIP",     en: "Custom + VIP audiences",   ok: true  },
      ...
      },
      {
        ...
        features:[
          ...
          { ar: "قاعدة بيانات مخصصة",     en: "Dedicated database",        ok: true  },
          { ar: "API كامل + دعم VIP ٢٤/٧", en: "Full API + 24/7 VIP support", ok: true },
        ],
      },
    ],
  },
