...
function FAQCTA({ lang, onLoginClick }: { lang: Lang; onLoginClick?: () => void }) {
  ...
  return (
    <div
      ref={ref}
      className="mt-16 bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 rounded-3xl p-7 flex flex-col sm:flex-row items-center justify-between gap-5"
      style={{
        opacity:    visible ? 1 : 0,
        transform:  visible ? "translateY(0)" : "translateY(24px)",
        transition: "opacity 0.7s cubic-bezier(0.16,1,0.3,1), transform 0.7s cubic-bezier(0.16,1,0.3,1)",
